...
class SiamNonLocalTrack(ModuleBase):
    r"""
    ...
    def __init__(self, backbone, head, loss=None):
        super(SiamNonLocalTrack, self).__init__()
    ...
    def forward(self, *args, phase="train"):
        ...
        if phase == 'train':
            ...
            # nonlocal block for emplar feature
    ...
    def _initialize_nonlocal(self):
        nonlocal_list = [self.cls_z_nonlocal, self.reg_z_nonlocal]
