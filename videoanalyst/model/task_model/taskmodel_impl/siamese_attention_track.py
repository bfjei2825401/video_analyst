...
class SiamAttentionTrack(ModuleBase):
    r"""
    ...
    def __init__(self, backbone, head, loss):
        super(SiamAttentionTrack, self).__init__()
    ...
    def forward(self, *args, phase="train"):
        ...
        if phase == 'train':
            ...
            # attention after backbone feature extraction
            # f_z = self.attention(f_z)
            # f_x = self.attention(f_x)
            # feature adjustment
    ...
    def _make_attention(self):
        ...
        self.attention = ResidualAttentionLayer(head_width,
